...
#
ax1 = pylab.subplot(gs[0, 1:-1])
ax1.boxplot(teen_conversation_message_lengths)
ax1.set_ylim((0, 300))
pylab.title('teen message lengths')
#
ax2 = pylab.subplot(gs[1,:2])
ax2.boxplot(teen_good_conversation_message_lengths)
ax2.set_ylim((0, 300))
pylab.title('teen good message lengths')
#
ax3 = pylab.subplot(gs[1,2:])
ax3.boxplot(teen_bad_conversation_message_lengths)
ax3.set_ylim((0, 300))
pylab.title('teen bad message lengths')
...
#
ax1 = pylab.subplot(gs[0, 1:-1])
ax1.boxplot(counselor_conversation_message_lengths)
ax1.set_ylim((0, 300))
pylab.title('counselor message lengths')
#
ax2 = pylab.subplot(gs[1,:2])
ax2.boxplot(counselor_good_conversation_message_lengths)
ax2.set_ylim((0, 300))
pylab.title('counselor good message lengths')
#
ax3 = pylab.subplot(gs[1,2:])
ax3.boxplot(counselor_bad_conversation_message_lengths)
ax3.set_ylim((0, 300))
pylab.title('counselor bad message lengths')
